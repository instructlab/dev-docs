...
[^10]: [Based on the SDG documentation](https://github.com/instructlab/sdg/blob/main/docs/dataset_formats.md#data-mixing-recipes-and-mixed-dataset-output), the process outputs JSON formats for the mixed datasets.
